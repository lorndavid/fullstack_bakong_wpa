...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'inventory/movements', name: 'stock-movements', component: () => import('@/pages/StockMovementsPage.vue') },
      ...
      { path: 'coupons/analytics', name: 'coupon-analytics', component: () => import('@/pages/CouponAnalyticsPage.vue') },
      { path: 'coupons/:id', name: 'coupon-detail', component: () => import('@/pages/CouponDetailPage.vue') },
